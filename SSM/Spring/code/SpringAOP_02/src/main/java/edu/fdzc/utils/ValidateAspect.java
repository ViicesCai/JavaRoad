...
public class ValidateAspect {
    ...
    @Before("edu.fdzc.utils.LogUtils.myPoint()")
    ...
    @AfterReturning(value = "edu.fdzc.utils.LogUtils.myPoint()", returning = "result")
    ...
    @AfterThrowing(value = "edu.fdzc.utils.LogUtils.myPoint()", throwing = "exception")
    ...
    @After("edu.fdzc.utils.LogUtils.myPoint()")
